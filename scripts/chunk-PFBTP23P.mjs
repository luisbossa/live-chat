...
var Qt = { delay: 0, duration: 0.2, ease: [0.44, 0, 0.56, 1], type: "tween" },
  ...
  sr = [
    ...
    ".framer-bJR9r.framer-k88sog { align-content: center; align-items: center; cursor: pointer; display: flex; flex-direction: row; flex-wrap: nowrap; justify-content: center; overflow: visible; padding: 4px 28px; position: relative; width: min-content; }",
...
var pr = { bounce: 0.2, delay: 0, duration: 0.4, type: "spring" },
  ...
  wr = [
    ...
    '.framer-7IJWt .framer-doz9jg { --framer-input-font-family: "Inter"; --framer-input-font-letter-spacing: 0em; --framer-input-font-line-height: 2%; --framer-input-font-size: 16px; --framer-input-font-weight: 400; --framer-input-padding: 8px 8px 8px 20px; flex: 1 0 0px; height: 64px; position: relative; width: 1px; }',
