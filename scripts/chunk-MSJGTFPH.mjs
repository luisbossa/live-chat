...
var w,
  ...
  z = (e) => (
    w ||
      ...
      (v = e.forwardRef((r, a) =>
        e.createElement("g", { ref: a, ...r }, w.get(r.weight))
      ))),
    v
  );
var x = z;
var U = {
  ...
  X = (e, r) => e.find((a) => a.toLowerCase().includes(r));
function R(e, r, a = "", n, p) {
  let S = F(() => {
    if (a == null || a?.length === 0) return null;
    let s = a.toLowerCase().replace(/-|\s/g, "");
    var l;
    return (l = p[s]) !== null && l !== void 0 ? l : X(e, s);
  }, [n, a]);
  return r ? n : S;
}
var L = [
...
function i(e) {
  let {
    ...
    c = b(!1),
    h = R(L, a, n, p, K),
    [T, y] = B(h === "Home" ? x(u) : null);
  async function G() {
    try {
      let I = await import(`${Z}${h}.js@0.0.57`);
      c.current && y(I.default(u));
    } catch {
      c.current && y(null);
    }
  }
  ...
  let O = d.current() === d.canvas ? t(D, {}) : null;
  return t(H.div, {
    ...
    children: T
      ? t("svg", {
          ...
          focusable: "false",
          color: r,
          children: t(T, { color: r, weight: E }),
        })
      : O,
  });
}
i.displayName = "Phosphor";
i.defaultProps = {
  width: 24,
  height: 24,
  iconSelection: "House",
...
M(i, {
  selectByList: {
    ...
    defaultValue: i.defaultProps.selectByList,
  },
  iconSelection: {
    type: o.Enum,
    options: L,
    defaultValue: i.defaultProps.iconSelection,
    title: "Name",
  ...
  color: { type: o.Color, title: "Color", defaultValue: i.defaultProps.color },
  weight: {
    type: o.Enum,
    title: "Weight",
    optionTitles: N.map((e) => e.charAt(0).toUpperCase() + e.slice(1)),
    options: N,
    defaultValue: i.defaultProps.weight,
  },
  mirrored: {
    type: o.Boolean,
    enabledTitle: "Yes",
    disabledTitle: "No",
    defaultValue: i.defaultProps.mirrored,
  },
  ...U,
});
export { i as a };
